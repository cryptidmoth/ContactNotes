...
2. Download the latest release ZIP file (e.g., `cryptidmoth-ContactNotes-0.0.1.zip`) from the [Releases](https://github.com/cryptidmoth/ContactNotes/releases) page.
